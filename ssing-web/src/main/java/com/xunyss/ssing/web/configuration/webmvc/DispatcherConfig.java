package com.xunyss.ssing.web.configuration.webmvc;
 ...
 */
@Configuration
@ComponentScan(basePackages="com.xunyss.ssing", useDefaultFilters=false, includeFilters={@Filter(Controller.class)})
