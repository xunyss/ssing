...
public class SimpleTest {
	...
	public void run() throws Exception {
		...
		iXASession = io.xunyss.ssing.xa.session.ClassFactory.createXASession();
	...
	//	boolean r = iXASession.connectServer("hts.etrade.co.kr", 20001);
		...
		iXAQuery1 = io.xunyss.ssing.xa.dataset.ClassFactory.createXAQuery();
		iXAQuery2 = io.xunyss.ssing.xa.dataset.ClassFactory.createXAQuery();
